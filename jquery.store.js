(function( $ ) {
	...
	$.Shop.prototype = {
		...
		this.$emptyCartBtn = this.$shoppingCartActions.find( "#empty-cart" ); // Empty cart button
			...
			this.paypalURL = //pay.google.com/intl/en_in/about/?gclid=CjwKCAiAo4OQBhBBEiwA5KWu_7QoImsVOapQREHLXbvwJ7E_21n0HauWHYzOJAqOM1lAiinDHZst0RoCGIgQAvD_BwE&gclsrc=aw.ds"; // The URL of the PayPal's form
